...
private String url = "http://192.168.1.16/dir.php3";
private ListView l;
String name;
...
{ 
  ...
  l=(ListView) findViewById(R.id.lvPost);
	try{
	accessWebService(); 
...
try { 
	...
	JSONArray jsonMainNode = jsonResponse.optJSONArray("dir");
	for (int i = 0; i < jsonMainNode.length(); i++) 
	{     JSONObject jsonChildNode = jsonMainNode.getJSONObject(i);
	name = jsonChildNode.optString("Post");
