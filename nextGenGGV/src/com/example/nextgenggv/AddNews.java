...
public class AddNews extends Activity {  private String jsonResult;
private String url = "http://192.168.1.19/course.php3";
...
try { 
	...
	String name = jsonChildNode.optString("course_id");
	
	String number = jsonChildNode.optString("course_Name");
	strname[i]=number;
	str[i]=jsonChildNode.optString("Extra");
...
listView.setOnItemClickListener(new OnItemClickListener() {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		intent.putExtra("cont",str[(int)arg3]);
		intent.putExtra("head",strname[(int)arg3]);
